...
if __name__ == '__main__':
    ...
    y, y_idx_list, y_data_n, y_labels,_,_ = dr.get_target_batch(0, 224, 224, target_dir=target_dir)
    Uy = np.loadtxt('./checkpoints/20190507-2231/max/Uybanana.txt', delimiter=",")
