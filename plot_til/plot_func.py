...
def plot_fake_xy(fake_y, fake_x, id_x, id_y, ori_x,ori_y,fake_dir,re_x,re_y):
    ...
    re_x_img=(np.array(re_x) + 1.0) * 127.5
    re_x_img=cv2.cvtColor(re_x_img, cv2.COLOR_RGB2BGR)
    re_y_img = (np.array(re_y) + 1.0) * 127.5
    re_y_img = cv2.cvtColor(re_y_img, cv2.COLOR_RGB2BGR)
    ...
    file_nameX=os.path.join(fake_dir,str(id_x)+'_fakeY.png')
    print(file_nameX)
    cv2.imwrite(file_nameX,fake_y_img)
    file_nameOY = os.path.join(fake_dir, str(id_y) + '_oriY.png')
    print(file_nameOY)
    cv2.imwrite(file_nameOY, ori_y)
    file_nameY = os.path.join(fake_dir, str(id_y) + '_fakeX.png')
    print(file_nameY)
    cv2.imwrite(file_nameY, fake_x_img)
    file_nameRX = os.path.join(fake_dir, str(id_x) + '_reX.png')
    print(file_nameRX)
    cv2.imwrite(file_nameRX, re_x_img)
    file_nameRY = os.path.join(fake_dir, str(id_y) + '_reY.png')
    print(file_nameRY)
    cv2.imwrite(file_nameRY, re_y_img)
