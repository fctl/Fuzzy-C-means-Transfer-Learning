...
tf.flags.DEFINE_string('Y', '/home/root123/data/datasets/target/cell_images/',
...
tf.flags.DEFINE_string('UC_name', "ring",
...
def train():
    ...
    with tf.Session(graph=graph) as sess:
        ...
        try:
            image_count=10
            t_img_path='/home/root123/data/datasets/target/toxo40/toxo40/toxo_0000019.png'
            s_img_path='/home/root123/data/datasets/source/banana/train/'
            plots_count=10
            ...
            #Cross Domain Image Generation#
                ...
                plot_fake_xy(fake_y_eval[0], fake_x_eval[0], str(i+1), str(i+1), x_oimg,y_oimg,fake_dir)
                print('processing:',i)
            ...
            #Feature Map Visualization#
                ...
                plot_conv_output(conv_y_eval[13],1,id_y_dir)
